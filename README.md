...
- A new required field `platform` must be specified (`alpine`, `linux`, `macos`, `windows`)
...
| :---:     |     :---:   |    :---:   |
| `platform` | Which platform of the uploader to use | *Required* Options include `apline` | `linux` | `macos` | `windows` |
